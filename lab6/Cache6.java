public class Cache6 {
    ...
    private int[] tagArray1 = new int[32]; // (2KB / 4W) / 4
    private int[] tagArray2 = new int[32]; // (2KB / 4W) / 4
    private int[] tagArray3 = new int[32]; // (2KB / 4W) / 4
    private int[] tagArray4 = new int[32]; // (2KB / 4W) / 4

    private int[] lineArray1 = new int[32];
    private int[] lineArray2 = new int[32];
    private int[] lineArray3 = new int[32];
    private int[] lineArray4 = new int[32];
    ...
    public void process(int address, int lineNumber) {
        ...
        int index = lab6.bitExtraction(address, 5, 4);
